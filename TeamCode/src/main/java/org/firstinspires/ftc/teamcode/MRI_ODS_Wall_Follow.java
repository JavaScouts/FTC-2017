...
/*public class MRI_ODS_Wall_Follow extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        mLeft.setMode(DcMotorController.RunMode.RUN_USING_ENCODERS);
        mRight.setMode(DcMotorController.RunMode.RUN_USING_ENCODERS);

        waitForStart();

        while (opModeIsActive()) {

            odsReadngRaw = ODS.getLightDetectedRaw();                       //update raw value
